...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Emmanuel Mura", "https://github.com/manumura",
			"emmanuel.mura@gmail.com");

	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Applications and Devices Management", "App/Dev Management Description", "1.0", "urn:tos",
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.manu.test.controller")).paths(PathSelectors.any())
